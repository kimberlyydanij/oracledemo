...
-- 테이블 구조를 복사 (쿼리문의 결과값을 가지고 와서 emp01이란 테이블로 생성해줌)
CREATE TABLE emp01
AS
SELECT first_name, salary
FROM employees
WHERE 1=0; --데이터의 구조만 복사해옴
...
-- 테이블의 모든 컬럼에 데이터를 삽입할때는 컬럼명을 생략할 수 있다.
INSERT INTO emp01
VALUES('Steven',4000);
...
테이블 내용을 수정
UPDATE table_name
SET column_nam=value, column_name=value
WHERE column_name = value;
*/

-- emp01테이블 first_name컬럼의 값이 'candy'일때 
-- salary 커럼값을 8000으로 업데이트 하세요.

UPDATE emp01
SET salary=8000
WHERE first_name='candy'; /* salary 값 5000->8000 수정*/
