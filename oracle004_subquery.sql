...
WHERE department_id=(
  ...
  -- 업무명(job_title), 입사일(hire_date)를 출력하시오.\
...
-- 'Bruce'보다 급여를 많이 받는 사원 이름(first_name), 부서명, 급여를 출력하시오.
...
-- 부서별로 가장 급여를 많이 받는 사원이름, 부서번호, 급여를 출려하시오.(in)
...
ORDER BY e.department_id;
 ...
 -- 30 소속된 모든 사원들의 급여보다  더 많은  급여를 받는
 ...
 WHERE salary > ALL ( 
  ...
  -- 30부서의 사원들이 받은 최저 급여보다  더 많은  급여를 받는
...
-- 월별 입사자 수를 조회하되 입사자수가 가장 맣은 상위 3개만 출력되도록 하시오.
